...
def print_sign(intg):
    if intg == 0:
        ...
        print "That's not an integer, silly goose. Try again."
...
def is_divisible_by_three(intg):
    if intg % 3 == 0:
        return True
    elif intg % 3 != 0:
        return False
    else:
        return "That's not an integer, silly goose. Try again."
...
def total_meal_price(meal_price, tip_percentage = .15):
    return meal_price + float(meal_price*tip_percentage)
...
parity, sign = sign_and_parity(42)

print "This is sign: ", sign, "This is parity: ", parity
...
def write_letter(recipient_name, job_title, sender_name):
    ...
    print "Dear %s, I think you are amazing! Sincerely, %s" % (recipient, sender_name)
